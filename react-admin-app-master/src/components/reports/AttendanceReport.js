...
const AttendanceReport=()=>{
    ...
    const handle_pdf_download=()=>{
        ...
        loans.forEach(element => {
            rows.push([element.Status,element.Employee,element.Type,element.Date,element.Time])
        });
        doc.autoTable({
            head: [['Status','Employee','Type', 'Date','Time']],
            body: rows,
        })
        doc.save("Attendance_Report");
    }
                    ...
                    <CCardBody>
                        <CDataTable
                            ...
                            fields={[
                                ...
                                'Status','Employee','Type', 'Date','Time'
                            ]}
                            light
                            hover
                            striped
